...
@Component({
  selector: 'app-incident-report-type-form',
  standalone: true,
  imports: [
    CommonModule,
    ReactiveFormsModule,
  ...
  template: `
    <form [formGroup]="form" class="space-y-4">
      ...
      <app-text-input label="Severity" name="severity" formControlName="severity" />
...
export class FormComponent {
  form: FormGroup;
  selectedItems: IncidentReportType[] = [];
  isSubmitting = false;
  @Output() onSubmit = new EventEmitter<string>();

  constructor(public service: IncidentReportTypeService) {
