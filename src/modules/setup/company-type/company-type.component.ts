...
import { FormComponent } from 'modules/setup/company-type/forms/form.component';
...
@Component({
  ...
  template: `
    <container>
      <app-header title="Manage Company Types" />
      <app-wrapper>
        <app-search
        ...
        <action-button
          ...
          class="w-full md:w-auto"
          icon="add"
          [isDisabled]="'' | cant : 'create' : 'CompanyType'"
          (action)="openDialog()"
        />
      </app-wrapper>
      <app-table
      ...
      >
        <ng-template #actionTemplate let-item>
          <icon-button
            [isDisabled]="'' | cant : 'update' : 'CompanyType'"
            icon="launch"
            tooltip="Edit Company Type"
            (action)="openDialog(item)"
            color="primary"
          />

          <icon-button
            [isDisabled]="'' | cant : 'delete' : 'CompanyType'"
            icon="delete_outline"
            tooltip="Delete Company Type"
            color="accent"
      ...
      >
        <ng-template>
          <app-company-type-form (onSubmit)="saveData($event)" />
        </ng-template>
      </app-dialog>
...
export class CompanyTypeComponent implements OnInit {
  ...
  constructor(public service: CompanyTypeService, private router: Router) {}
