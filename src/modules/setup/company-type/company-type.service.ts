...
export class CompanyTypeService {
  private readonly API = 'company-types';
  private items: CompanyType[] = [];
  ...
  create(data: CompanyType): Observable<ApiResponse> {
    return this.httpService.post<ApiResponse>(this.API, data);
  }

  update(uuid: string, item: CompanyType): Observable<ApiResponse> {
