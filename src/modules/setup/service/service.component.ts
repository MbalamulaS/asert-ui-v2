...
import { FormComponent } from 'modules/setup/service/forms/form.component';
import { ContainerComponent } from 'components/container/container.component';
import { ServiceService } from 'modules/setup/service/service.service';
...
@Component({
  ...
  template: `
    <container>
      <app-header title="Manage Services" />
      <app-wrapper>
        <app-search
        ...
        <action-button
          ...
          class="w-full md:w-auto"
          icon="add"
          [isDisabled]="'' | cant: 'create' : 'Service'"
          (action)="openDialog()"
        />
      </app-wrapper>
      <app-table
      ...
      >
        <ng-template #actionTemplate let-item>
          <icon-button
            [isDisabled]="'' | cant: 'update' : 'Service'"
            icon="launch"
            tooltip="Edit Role"
          ...
          <icon-button
            [isDisabled]="'' | cant: 'delete' : 'Service'"
            icon="delete_outline"
            tooltip="Delete Role"
            color="accent"
      ...
      >
        <ng-template>
          <app-service-form (onSubmit)="saveData($event)" />
        </ng-template>
      </app-dialog>
...
export class ServiceComponent implements OnInit {
  ...
  columns = [
    ...
    { label: 'Category', value: 'serviceCategoryName' },
  ];
