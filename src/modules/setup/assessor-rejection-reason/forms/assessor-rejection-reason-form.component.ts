...
import {
  AssessorRejectionReasonService
} from "modules/setup/assessor-rejection-reason/assessor-rejection-reason.service";
...
@Component({
  selector: 'app-assessor-rejection-reason-form',
  standalone: true,
  imports: [
    CommonModule,
    ReactiveFormsModule,
...
export class AssessorRejectionReasonFormComponent {
  form: FormGroup;
  isSubmitting = false;
