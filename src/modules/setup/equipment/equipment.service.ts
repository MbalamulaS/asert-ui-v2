...
export class EquipmentService {
  private readonly API = 'equipments';
  ...
  form = new FormGroup({
    ...
    equipmentCategoryId: new FormControl(null, [Validators.required]),
  });
  ...
  create(item: Equipment): Observable<ApiResponse> {
    return this.httpService.post<ApiResponse>(this.API, item);
  }

  update(uuid: string, item: Equipment): Observable<ApiResponse> {
