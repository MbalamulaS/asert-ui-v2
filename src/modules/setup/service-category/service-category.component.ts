...
import { FormComponent } from 'modules/setup/service-category/forms/form.component';
import { ServiceCategoryService } from 'modules/setup/service-category/service-category.service';
...
@Component({
  ...
  template: `
    <container>
      <app-header title="Manage Service Categories" />
      <app-wrapper>
        <app-search
        ...
        <action-button
          ...
          class="w-full md:w-auto"
          icon="add"
          [isDisabled]="'' | cant: 'create' : 'ServiceCategory'"
          (action)="openDialog()"
        />
      </app-wrapper>
      <app-table
      ...
      >
        <ng-template #actionTemplate let-item>
          <icon-button
            [isDisabled]="'' | cant: 'update' : 'ServiceCategory'"
            icon="launch"
          ...
          <icon-button
            [isDisabled]="'' | cant: 'delete' : 'ServiceCategory'"
            icon="delete_outline"
            tooltip="Delete Service Category"
            color="accent"
      ...
      >
        <ng-template>
          <app-service-category-form (onSubmit)="saveData($event)" />
        </ng-template>
      </app-dialog>
