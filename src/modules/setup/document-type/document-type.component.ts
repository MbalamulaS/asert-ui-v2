...
import {DocumentTypeFormComponent} from "modules/setup/document-type/forms/document-type-form.component";
    ...
    <container>
      ...
      <app-wrapper>
        ...
        <action-button
          ...
          class="w-full md:w-auto"
          icon="add"
          [isDisabled]="'' | cant: 'create' : 'DocumentType'"
          (action)="openDialog()"
        />
      </app-wrapper>
      <app-table
      ...
      >
        ...
        <ng-template #actionTemplate let-item>
          <icon-button
            [isDisabled]="'' | cant: 'update' : 'DocumentType'"
            icon="launch"
            tooltip="Edit DocumentType"
            (action)="openDialog(item)"
            color="primary"
          />

          <icon-button
            [isDisabled]="'' | cant: 'delete' : 'DocumentType'"
            icon="delete_outline"
      ...
      >
        <ng-template>
          <app-document-type-form (onSubmit)="saveData($event)"/>
        </ng-template>
      </app-dialog>
